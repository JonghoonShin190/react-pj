    ...
    <div>
      ...
      <StyledForm className="ReviewForm" onSubmit={handleSubmit}>
        * 리뷰 제목
        ...
        <div style={{ border: '1px solid #ccc', padding: '16px', borderRadius: '4px', marginTop: '10px', marginBottom: '20px' }}>
          <div style={{ display: 'flex', alignItems: 'center' }}>
            <h4 style={{ color: 'gray', fontSize: '14px', marginRight: '90px' }}>[1] 강사진의 강의력</h4>
            <ReviewFormRating
              name="teachRating"
              label="[1] 강사진의 강의력"
          ...
          <div style={{ display: 'flex', alignItems: 'center' }}>
            <h4 style={{ color: 'gray', fontSize: '14px', marginRight: '48px' }}>[2] 커리큘럼·교재의 우수성</h4>
            <ReviewFormRating
              name="curriclmRating"
          ...
          <div style={{ display: 'flex', alignItems: 'center' }}>
            <h4 style={{ color: 'gray', fontSize: '14px', marginRight: '48px' }}>[3] 상담·의사소통의 원할함</h4>
            <ReviewFormRating
              name="serviceRating"
          ...
          <div style={{ display: 'flex', alignItems: 'center' }}>
            <h4 style={{ color: 'gray', fontSize: '14px', marginRight: '50px' }}> [4] 학사·행정관리의 체계성</h4>
            <ReviewFormRating
              name="convRating"
          ...
          <div style={{ display: 'flex', alignItems: 'center' }}>
            <h4 style={{ color: 'gray', fontSize: '14px', marginRight: '80px' }}> [5] 시설·환경의 편의성</h4>
            <ReviewFormRating
              name="costRating"
              label="[5] 시설·환경의 편의성"
        ...
        <div style={{ backgroundColor: '#dff1f9', borderRadius: '4px', padding: '10px', fontSize: '5px', color: 'gray' }}>
          <p>
            • 본 후기는 학뷰 운영팀의 검수를 거쳐 게시됩니다. 다른 사용자들에게 도움이 되는
            후기를 작성했는지 충분히 검토 후 제출해주세요.
          </p>
          <p>
            • 검수 과정에서 허위, 조작, 비방, 욕설, 무의미한 내용 등으로 작성된 후기는 반려처리되며,
